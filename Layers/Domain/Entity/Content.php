...
/**
 * PiApp\GedmoBundle\Layers\Domain\Entity\Content
 *
 * @ORM\Table(name="gedmo_content")
 * @ORM\Entity(repositoryClass="PiApp\GedmoBundle\Repository\ContentRepository")
 * @ORM\HasLifecycleCallbacks()
 * @Gedmo\TranslationEntity(class="PiApp\GedmoBundle\Layers\Domain\Entity\Translation\ContentTranslation")
 *
...
class Content extends AbstractDefault  
{
     ...
     * @access  protected
     */
    protected $_translationClass = 'PiApp\GedmoBundle\Layers\Domain\Entity\Translation\ContentTranslation';

    /**
     * @var \Doctrine\Common\Collections\ArrayCollection
     *
     * @ORM\OneToMany(targetEntity="PiApp\GedmoBundle\Layers\Domain\Entity\Translation\ContentTranslation", mappedBy="object", cascade={"persist", "remove"})
     */
     ...
     *
     * @ORM\ManyToOne(targetEntity="PiApp\GedmoBundle\Layers\Domain\Entity\Category", inversedBy="items_content")
