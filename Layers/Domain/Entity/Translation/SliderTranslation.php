 ...
 * @since      2015-02-16
 */
class SliderTranslation extends AbstractTranslationEntity
{
    /**
     * @ORM\ManyToOne(targetEntity="PiApp\GedmoBundle\Layers\Domain\Entity\Slider", inversedBy="translations")
