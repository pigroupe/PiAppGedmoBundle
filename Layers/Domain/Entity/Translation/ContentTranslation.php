 ...
 * @ORM\Table(
 *         name="gedmo_content_translations",
 *         uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx_sfynx_trans_cmfplugin_content", columns={
 ...
 * @since      2015-02-16
 */
class ContentTranslation extends AbstractTranslationEntity
{
    /**
     * @ORM\ManyToOne(targetEntity="PiApp\GedmoBundle\Layers\Domain\Entity\Content", inversedBy="translations")
