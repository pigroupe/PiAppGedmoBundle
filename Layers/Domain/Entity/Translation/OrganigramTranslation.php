 ...
 * @ORM\Table(
 *         name="gedmo_organigram_translations",
 *         uniqueConstraints={@ORM\UniqueConstraint(name="lookup_unique_idx_sfynx_trans_organigram", columns={
 ...
 * @since      2015-02-16
 */
class OrganigramTranslation extends AbstractTranslationEntity
{
    /**
     * @ORM\ManyToOne(targetEntity="PiApp\GedmoBundle\Layers\Domain\Entity\Organigram", inversedBy="translations")
